...
Background:
  ...
  Scenario: Sort Symbol column by clicking and verifying instrument type from directory response
  ...
  Scenario: Sort Name column by clicking and verifying instrument type from directory response
